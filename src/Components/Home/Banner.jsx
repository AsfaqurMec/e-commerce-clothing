    ...
    return (
      ...
      >
        <SwiperSlide className='rounded-sm w-full h-[60vh] md:h-[61vh] bg-cover bg-center bg-no-repeat bg-[url("https://i.ibb.co/5Mh71sb/Screenshot-2024-08-01-193713.pnghttps://i.ibb.co/MsRhtd6/Screenshot-2024-08-01-235858.png")]'>
            ...
            <div className='w-full gap-4 h-[60vh] md:h-[61vh] flex flex-col justify-center items-start pl-8 bg-cover bg-center bg-no-repeat bg-[url("https://i.ibb.co/MsRhtd6/Screenshot-2024-08-01-235858.png")]'>
            ...
            <h1 className='   font-medium tracking-[.12em] mt-5 text-3xl text-red-600'>Hot Trending</h1>
            <div className='flex flex-col gap-3 md:flex-row'>
            <Link to="/register"><button className='btn text-white bg-black border-none rounded-sm hover:bg-sky-700 px-5 font-semibold  text-2xl'>Shop Now</button></Link>
        ...
        <SwiperSlide className='rounded-sm w-full h-[60vh] md:h-[61vh] bg-cover bg-center bg-no-repeat bg-[url("https://i.ibb.co/YhB3dRR/Screenshot-2024-08-02-000407.png")]'>
            ...
            <div className='w-full gap-4 h-[60vh] md:h-[61vh] flex flex-col justify-center items-start pl-8 bg-cover bg-center bg-no-repeat bg-[url("https://i.ibb.co/YhB3dRR/Screenshot-2024-08-02-000407.png")]'>
            
            <h1 className='  text-white font-bold text-4xl mb-1 md:text-7xl space-y-6 uppercase'>Men's</h1>
            <h1 className='  text-white font-bold text-4xl  md:text-7xl space-y-6 uppercase'>Fashion</h1>
            <h1 className='  text-white font-medium tracking-[.12em] text-3xl'>SUMMER COLLECTION!!</h1>
            <h1 className='   font-medium tracking-[.12em] mt-5 text-3xl text-red-600'>Hot Trending</h1>
            <div className='flex flex-col gap-3 md:flex-row'>
            <Link to="/register"><button className='btn text-white bg-black border-none rounded-sm hover:bg-sky-700 px-5 font-semibold  text-2xl'>Shop Now</button></Link>
