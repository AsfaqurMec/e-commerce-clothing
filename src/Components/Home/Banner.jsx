        ...
        <div className="flex gap-5">
           <div className="w-1/4 bg-blue-950  text-white font-semibold text-lg hidden lg:flex">
            <div className="flex flex-col justify-center items-start w-full ">
               <Link className="flex gap-5 mb-5 text-xl w-full hover:bg-orange-600 pl-10 py-2"><IoWoman /> WOMEN'S CLOTHING</Link>
               <Link className="flex gap-5 mb-5 text-xl w-full hover:bg-orange-600 pl-10 py-2"><IoIosMan /> MEN'S CLOTHING</Link>
               <Link className="flex gap-5 mb-5 text-xl w-full hover:bg-orange-600 pl-10 py-2"><MdWatch /> WATCHES</Link>
               <Link className="flex gap-5 mb-5 text-xl w-full hover:bg-orange-600 pl-10 py-2"><GiShoppingBag /> BAGS</Link>
               <Link className="flex gap-5 mb-5 text-xl w-full hover:bg-orange-600 pl-10 py-2"><GiRunningShoe /> SHOES</Link>
